...
<template>
  <BaseForm
    ...
    :initial="{ property: null, room_type: null, amenities: [], number: '', floor: 0, daily_rate: 0, status: 'AVAILABLE', description: '', is_active: true, photo: null }"
  >
    <template #default="{ form, submit, loading, isEdit }">
      <q-form @submit.prevent="() => submit(form)" class="q-gutter-md">
        ...
        <BaseResourceSelect v-model="form.amenities" resource="amenities" label="Comodidades" :multiple="true" />
