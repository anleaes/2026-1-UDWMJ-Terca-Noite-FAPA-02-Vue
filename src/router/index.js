...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'employees',             name: 'employees-list', component: () => import('../pages/employees/EmployeeListPage.vue'), meta: { requiresAuth: true } },
      { path: 'employees/novo',        name: 'employees-add',  component: () => import('../pages/employees/EmployeeFormPage.vue'), meta: { requiresAuth: true } },
      { path: 'employees/:id/editar',  name: 'employees-edit', component: () => import('../pages/employees/EmployeeFormPage.vue'), meta: { requiresAuth: true } },
      { path: 'guests',             name: 'guests-list', component: () => import('../pages/guests/GuestListPage.vue'), meta: { requiresAuth: true } },
      { path: 'guests/novo',        name: 'guests-add',  component: () => import('../pages/guests/GuestFormPage.vue'), meta: { requiresAuth: true } },
      { path: 'guests/:id/editar',  name: 'guests-edit', component: () => import('../pages/guests/GuestFormPage.vue'), meta: { requiresAuth: true } },
      { path: 'invoices',             name: 'invoices-list', component: () => import('../pages/invoices/InvoiceListPage.vue'), meta: { requiresAuth: true } },
      { path: 'invoices/novo',        name: 'invoices-add',  component: () => import('../pages/invoices/InvoiceFormPage.vue'), meta: { requiresAuth: true } },
      { path: 'invoices/:id/editar',  name: 'invoices-edit', component: () => import('../pages/invoices/InvoiceFormPage.vue'), meta: { requiresAuth: true } },
      ...
      { path: 'reviews',             name: 'reviews-list', component: () => import('../pages/reviews/ReviewListPage.vue'), meta: { requiresAuth: true } },
      { path: 'reviews/novo',        name: 'reviews-add',  component: () => import('../pages/reviews/ReviewFormPage.vue'), meta: { requiresAuth: true } },
      { path: 'reviews/:id/editar',  name: 'reviews-edit', component: () => import('../pages/reviews/ReviewFormPage.vue'), meta: { requiresAuth: true } },
      { path: 'service-categories',             name: 'service_categories-list', component: () => import('../pages/service_categories/ServiceCategoryListPage.vue'), meta: { requiresAuth: true } },
      { path: 'service-categories/novo',        name: 'service_categories-add',  component: () => import('../pages/service_categories/ServiceCategoryFormPage.vue'), meta: { requiresAuth: true } },
      { path: 'service-categories/:id/editar',  name: 'service_categories-edit', component: () => import('../pages/service_categories/ServiceCategoryFormPage.vue'), meta: { requiresAuth: true } },
      { path: 'services',             name: 'services-list', component: () => import('../pages/services/ServiceListPage.vue'), meta: { requiresAuth: true } },
      { path: 'services/novo',        name: 'services-add',  component: () => import('../pages/services/ServiceFormPage.vue'), meta: { requiresAuth: true } },
      { path: 'services/:id/editar',  name: 'services-edit', component: () => import('../pages/services/ServiceFormPage.vue'), meta: { requiresAuth: true } },
    ],
  },
]
